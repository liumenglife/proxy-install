...
```json
{
  ...
  "outbounds": [
    ...
    // 如: 香港-机场A-节点1, 日本-机场B-节点2

    // ── 全部聚合分组 ──
    { "type": "urltest", "tag": "全部聚合/自动组", "outbounds": ["香港-...", "日本-...", "新加坡-...", "美国-...", "其他节点..."], "interval": "20s" },
    { "type": "selector", "tag": "全部聚合/手动组", "outbounds": ["香港-...", "日本-...", "所有节点..."] },
    ...
    // ── 按地区分组 ──
    { "type": "urltest", "tag": "按地区/香港/自动组", "outbounds": ["香港-节点1", "香港-节点2", ...], "interval": "20s" },
    { "type": "selector", "tag": "按地区/香港/手动组", "outbounds": ["香港-节点1", "香港-节点2", ...] },
    { "type": "urltest", "tag": "按地区/日本/自动组", "outbounds": ["日本-节点1", "日本-节点2", ...], "interval": "20s" },
    { "type": "selector", "tag": "按地区/日本/手动组", "outbounds": ["日本-节点1", "日本-节点2", ...] },
    { "type": "urltest", "tag": "按地区/新加坡/自动组", "outbounds": ["新加坡-节点1", "新加坡-节点2", ...], "interval": "20s" },
    { "type": "selector", "tag": "按地区/新加坡/手动组", "outbounds": ["新加坡-节点1", "新加坡-节点2", ...] },
    { "type": "urltest", "tag": "按地区/美国/自动组", "outbounds": ["美国-节点1", "美国-节点2", ...], "interval": "20s" },
    { "type": "selector", "tag": "按地区/美国/手动组", "outbounds": ["美国-节点1", "美国-节点2", ...] }
  ],
  "route": {
    "rules": [
...
4. 实际路由标签显示：`按地区/香港/自动组 → 香港-节点3`

**手动模式：**
1. Web UI → 直接打开任意手动组（如 `按地区/香港/手动组`）
2. 选 `香港-节点2`
3. `route.final` 更新为 `按地区/香港/手动组` + 在该组内选中 `香港-节点2`
4. 代理选择器反向更新为 `按地区/香港/手动组`
5. 实际路由标签显示：`按地区/香港/手动组 → 香港-节点2`
